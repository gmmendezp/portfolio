...
This project was created by using the [create-react-app](https://github.com/facebookincubator/create-react-app) tool, ejecting and changing to use technologies I wanted to use.
...
The app uses [Tape](https://github.com/substack/tape) as the test runner. The tests run in a Node environment and not in a real browser.

We recommend that you use a separate tool for browser end-to-end tests if you need them. They are beyond the scope.

### Filename Conventions

The app will look for test files with any of the following popular naming conventions:
